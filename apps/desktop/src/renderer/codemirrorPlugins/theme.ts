/**
 * CodeMirror 6 theme for desktop editor
 * Adapted from TEE theme.ts with desktop-specific font adjustments
 */
import { HighlightStyle } from "@codemirror/language";
import { EditorView } from "@codemirror/view";
import { tags } from "@lezer/highlight";

const ESSAY_STYLES: Record<string, Record<string, string>> = {
  "&": {},
